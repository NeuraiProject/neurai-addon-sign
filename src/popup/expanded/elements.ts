...
export const elements = {
  ...
  portfolioDepinPanel: document.getElementById('portfolioDepinPanel'),
  depinModeTabs: document.getElementById('depinModeTabs'),
  depinCardTitle: document.getElementById('depinCardTitle'),
  depinCardCopy: document.getElementById('depinCardCopy'),
  depinAssetsSection: document.getElementById('depinAssetsSection'),
  depinCreateSection: document.getElementById('depinCreateSection'),
  depinCreateRefreshBtn: document.getElementById('depinCreateRefreshBtn') as HTMLButtonElement | null,
  depinManageSection: document.getElementById('depinManageSection'),
  depinManagePrompt: document.getElementById('depinManagePrompt'),
  depinManagePromptCard: document.getElementById('depinManagePromptCard'),
  depinSendPromptCard: document.getElementById('depinSendPromptCard'),
  depinManageBody: document.getElementById('depinManageBody'),
  depinSendSection: document.getElementById('depinSendSection'),
  depinSendPrompt: document.getElementById('depinSendPrompt'),
  depinSendBody: document.getElementById('depinSendBody'),
  depinSendTitle: document.getElementById('depinSendTitle'),
  depinSendHint: document.getElementById('depinSendHint'),
  depinViewTab: document.getElementById('depinViewTab') as HTMLButtonElement | null,
  depinRefreshBtn: document.getElementById('depinRefreshBtn') as HTMLButtonElement | null,
  depinAssetList: document.getElementById('depinAssetList'),
  depinDevicesTitle: document.getElementById('depinDevicesTitle'),
  depinModeToggle: document.getElementById('depinModeToggle'),
  depinDevicesHint: document.getElementById('depinDevicesHint'),
  depinDeviceList: document.getElementById('depinDeviceList'),
  depinSelectAll: document.getElementById('depinSelectAll') as HTMLButtonElement | null,
  depinClearSelection: document.getElementById('depinClearSelection') as HTMLButtonElement | null,
  depinApplyBtn: document.getElementById('depinApplyBtn') as HTMLButtonElement | null,
  depinDevicesError: document.getElementById('depinDevicesError'),
  depinMintGroup: document.getElementById('depinMintGroup'),
  depinMintAmount: document.getElementById('depinMintAmount') as HTMLInputElement | null,
  depinMintBtn: document.getElementById('depinMintBtn') as HTMLButtonElement | null,
  depinMintError: document.getElementById('depinMintError'),
  depinAssignAddress: document.getElementById('depinAssignAddress') as HTMLInputElement | null,
  depinAssignAmount: document.getElementById('depinAssignAmount') as HTMLInputElement | null,
  depinAssignBtn: document.getElementById('depinAssignBtn') as HTMLButtonElement | null,
  depinAssignError: document.getElementById('depinAssignError'),
  depinParentSelect: document.getElementById('depinParentSelect') as HTMLSelectElement | null,
  depinParentHint: document.getElementById('depinParentHint'),
  depinNewName: document.getElementById('depinNewName') as HTMLInputElement | null,
  depinNameHint: document.getElementById('depinNameHint'),
  depinNewQuantity: document.getElementById('depinNewQuantity') as HTMLInputElement | null,
  depinCreateBtn: document.getElementById('depinCreateBtn') as HTMLButtonElement | null,
  depinCreateError: document.getElementById('depinCreateError'),
  depinResult: document.getElementById('depinResult'),
  depinTxid: document.getElementById('depinTxid'),
  depinTxExplorerLink: document.getElementById('depinTxExplorerLink') as HTMLAnchorElement | null,
  ...
  sendRecipients: document.getElementById('sendRecipients'),
  sendAddRecipientBtn: document.getElementById('sendAddRecipientBtn') as HTMLButtonElement | null,
  sendSubmitBtn: document.getElementById('sendSubmitBtn') as HTMLButtonElement | null,
  sendError: document.getElementById('sendError'),
  sendResult: document.getElementById('sendResult'),
  sendTxid: document.getElementById('sendTxid'),
  sendTxExplorerLink: document.getElementById('sendTxExplorerLink') as HTMLAnchorElement | null,
  sendNewBtn: document.getElementById('sendNewBtn') as HTMLButtonElement | null,
  ...
  caTxConfirmSubtitle: document.getElementById('caTxConfirmSubtitle'),
  caTxConfirmProgress: document.getElementById('caTxConfirmProgress'),
  caTxConfirmStatus: document.getElementById('caTxConfirmStatus'),
  ...
  cfAddressesLabel: document.getElementById('cfAddressesLabel'),
  cfAddressesHint: document.getElementById('cfAddressesHint'),
  cfHoldersGroup: document.getElementById('cfHoldersGroup'),
  cfHoldersLabel: document.getElementById('cfHoldersLabel'),
  cfHoldersRefreshBtn: document.getElementById('cfHoldersRefreshBtn') as HTMLButtonElement | null,
  cfHoldersBanner: document.getElementById('cfHoldersBanner'),
  cfHoldersList: document.getElementById('cfHoldersList'),
  cfHoldersSelectAll: document.getElementById('cfHoldersSelectAll') as HTMLButtonElement | null,
  cfHoldersClear: document.getElementById('cfHoldersClear') as HTMLButtonElement | null,
  cfHoldersHint: document.getElementById('cfHoldersHint'),
